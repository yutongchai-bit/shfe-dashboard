...
Run daily by GitHub Actions (see .github/workflows/daily.yml).
Layout: repo root contains data/, scripts/, this file, index.html (output).
"""
...
def get(params):
    for attempt in range(3):
        try:
            ...
            if j.get('success'):
                return j['result']
            if '为空' in str(j.get('message', '')):  # empty result
                return None
...
def main():
    ...
    # pipeline writes shfe_live_artifact.html at repo root -> serve as index.html
